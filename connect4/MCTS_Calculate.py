...
def run_game():
    ...
    while not game_over:
        ...
        if connect_state.is_terminal_node():
            print("Game over")
            game_over = True
...
for i in range(NUM_RUNS):
    ...
    if final_state.winning_move(PLAYER_PIECE):
        player_wins += 1
    elif final_state.winning_move(AI_PIECE):
        ai_wins += 1

print(f"\nPlayer won {player_wins} times, AI won {ai_wins} times.")
